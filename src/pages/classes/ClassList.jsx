...
const blankForm = { name: "", description: "", schoolId: "" };
...
const ClassList = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const path = editingId ? `/api/classes/${editingId}` : "/api/classes";
      const method = editingId ? "PUT" : "POST";
      const res = await client({ path, method, body: payload });
  ...
  const handleDelete = async (id) => {
    ...
    setMessage("");
    try {
      const res = await client({ path: `/api/classes/${id}`, method: "DELETE" });
                            ...
                            return (
                              <tr key={id}>
                                <td>
                                  ...
                                  <span className="sub-text text-soft">#{id}</span>
                                </td>
                                <td>{item.schoolId || item.schoolID || "—"}</td>
